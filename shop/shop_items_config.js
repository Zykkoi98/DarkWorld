window.GAME_ITEMS_DATABASE = Object.assign(window.GAME_ITEMS_DATABASE || {}, {
  ...
  'scrappy_cleaver_2': { name: 'Орочий Расчленитель', icon: '🔱', slotType: 'twoHanded', price: 45, level: 3, req: { luck: 7 }, desc: 'Двуручная огромная сабля.', bonus: { atk: 10, mf_crit: 25 } },
  ...
  'ravager_maul_5': { name: 'Молот Разрушителя', icon: '🔨', slotType: 'twoHanded', price: 300, level: 9, req: { luck: 25 }, desc: 'Огромная кувалда.', bonus: { atk: 26, mf_crit: 60 } },
